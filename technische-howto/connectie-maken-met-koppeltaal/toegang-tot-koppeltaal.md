...
{% swagger-parameter name="client:assertion" type="string" required="true" in="body" %}
Het ondertekende JWT token
{% endswagger-parameter %}

{% swagger-parameter name="client:assertion:type" type="string" required="true" in="body" %}
Altijd vullen met 

`urn:ietf:params:oauth:client-assertion-type:jwt-bearer`
{% endswagger-parameter %}

{% swagger-parameter name="grant:type" type="string" required="true" in="body" %}
Altijd vullen met 

`client_credentials`
{% endswagger-parameter %}

{% swagger-parameter name="scope" type="string" required="true" in="body" %}
